...
public class main {
    public static void main(String[] args) {
        ...
        User U_71200534 = new User("Nama Kamu", "Email Kamu", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200534 = new GoPay(U_71200534);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71200534.getUser().getNama()+"] - ");
        E_71200534.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71200534.getUser().getNama()+"] - ");
        E_71200534.topup(50000);
        System.out.print("["+E_71200534.getUser().getNama()+"] - ");
        E_71200534.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71200534, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71200534.getUser().getNama()+"] - ");
        E_71200534.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71200534.getUser().getNama()+"] - ");
        E_71200534.withdraw(1100);
